...
async def _mp3(msg):
    ...
    await run_cmd(f'ffmpeg -i /downloads/{dl} -acodec libmp3lame -qscale:a 2 /downloads/{dl}.mp3')
    message = await msg.edit("`Uploading...`")
    await msg.client.send_file(msg.chat_id, '/downloads/' + dl.file_name + '.mp3', caption='Converted', progress_callback=lambda d, t: asyncio.get_event_loop().create_task(
